...
execute unless data block -30000000 0 1602 Items[0].tag.Enchantments[{id:"minecraft:riptide"}] run data modify block -30000000 0 1602 Items[0].tag.Enchantments append value {id:"minecraft:riptide",lvl:1}
data modify block -30000000 0 1602 Items[0].tag.Enchantments[{id:"minecraft:riptide"}].lvl set from block -30000000 0 1602 Items[0].tag.RiptideLvl
data remove block -30000000 0 1602 Items[0].tag.RiptideLvl
data remove block -30000000 0 1602 Items[0].tag.display.Lore[-1]
