...
execute unless data block -30000000 0 1602 Items[0].tag.Enchantments[{id:"minecraft:riptide"}] run item modify block -30000000 0 1602 container.0 trident:add_enchantment
